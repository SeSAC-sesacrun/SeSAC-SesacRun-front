...
export default function CourseDetailPage() {
  ...
  const [activeTab, setActiveTab] = useState<
    "intro" | "curriculum" | "instructor" | "reviews" | "qna"
  >("intro");
    ...
    const fetchCourseDetail = async () => {
      try {
        ...
        const formattedCourse = {
          ...
          detailedDescription:
            data.detailedDescription || "상세 설명이 없습니다.",
          instructor: {
                  ...
                  >
                    <div className="absolute inset-0 bg-black/30 flex items-center justify-center rounded-lg group-hover:bg-black/40 transition-colors">
                      <div className="flex items-center justify-center size-16 bg-white/90 rounded-full">
                        <span
                          className="material-symbols-outlined text-gray-900 text-3xl"
                    ...
                    <div className="prose dark:prose-invert max-w-none">
                      <div
                        ...
                        dangerouslySetInnerHTML={{
                          __html: course.detailedDescription,
                        }}
                      />
                    </div>
                  )}
                            ...
                            {section.lectures.map((lecture) => (
                              <div
                                ...
                                className={`p-4 flex items-center justify-between transition-colors ${
                                  course?.canWatch || lecture.videoUrl
        ...
        >
          ...
          >
            ...
            <div className="aspect-video bg-black rounded-lg overflow-hidden">
              ...
              getYoutubeVideoId(previewLecture.videoUrl) ? (
                <iframe
                  width="100%"
                  height="100%"
