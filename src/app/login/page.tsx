          ...
          <form onSubmit={handleSubmit} className="mt-6 flex flex-col gap-4">
            ...
            <div className="mt-2">
                <button
                    disabled={isLoading}
                    type="submit"
                    className={`flex h-12 w-full items-center justify-center rounded-lg bg-primary px-6 text-base font-bold text-black dark:text-white shadow-sm transition-colors hover:bg-primary/90 disabled:opacity-50 disabled:cursor-not-allowed`}
                >
                    {isLoading ? (
                        <span className="flex items-center gap-2">
                            <svg className="h-5 w-5 animate-spin text-black dark:text-white" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
